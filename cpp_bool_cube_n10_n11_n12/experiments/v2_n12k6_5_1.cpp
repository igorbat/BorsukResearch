...
std::string FILENAME = "/root/science/bruteforce_via_kissat/Borsuk_plus_kissat/build/n12k6_5_1.txt";
...
int main() {
    ...
    std::vector<int> starting_vertexes = {0, 0b111111000000, 0b111000111000, 0b010101101100, 0b100011011100 };

    std::vector<FuncPtr> filters;
    filters.push_back(is_inside);
    filters.push_back(is_not_created_k5_5_or_4_or_3_or_2);
