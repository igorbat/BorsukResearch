...
std::string FILENAME = "/root/science/bruteforce_via_kissat/Borsuk_plus_kissat/build/n10k6_3.txt";
std::string command_2 = " -q --time=60";
...
int main() {
    ...
    BruteforceSolver solver(results, que, filters, command_1 + FILENAME + command_2, FILENAME, N, K, starting_vertexes.size(), 30);
    solver.run();
