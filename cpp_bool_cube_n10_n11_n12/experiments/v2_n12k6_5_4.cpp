...
std::string FILENAME = "/root/science/bruteforce_via_kissat/Borsuk_plus_kissat/build/n12k6_5_4.txt";
...
int main() {
    ...
    std::vector<int> starting_vertexes = {0, 0b111111000000, 0b111000111000, 0b101010010101, 0b101100100110 };

    std::vector<FuncPtr> filters;
    filters.push_back(is_inside);
    filters.push_back(is_not_created_k5_5);
