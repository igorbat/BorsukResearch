...
std::string FILENAME = "/root/science/bruteforce_via_kissat/Borsuk_plus_kissat/build/n12k6_3.txt";
...
int main() {
    ...
    std::vector<int> starting_vertexes = {0, 0b111111000000, 0b111000111000 };
