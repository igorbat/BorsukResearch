...
std::string FILENAME = "n10k6_6.txt";
std::string command_2 = " -q --time=2";
...
int main() {
    ...
    std::vector<int> starting_vertexes = {0, 0b1111110000, 0b1110001110, 0b1000110111, 0b0101011011, 0b0011101101 };
