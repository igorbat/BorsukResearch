...
int main(int argc, char** argv) {
    // Пути можно задать аргументами:  v2_n11k6_2 <путь к kissat> <рабочий каталог>
    ...
    const std::string FILENAME  = workdir + "/n11k6_2.txt";
    ...
    std::vector<int> starting_vertexes = {0, 0b11111100000 };
    ...
    BruteforceSolver solver(results, que, filters, command_1 + FILENAME + command_2, FILENAME, N, K, starting_vertexes.size(), 200);
    solver.run();
