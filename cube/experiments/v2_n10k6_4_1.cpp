...
int main(int argc, char** argv) {
    // Пути можно задать аргументами:  v2_n10k6_4_1 <путь к kissat> <рабочий каталог>
    ...
    const std::string FILENAME  = workdir + "/n10k6_4_1.txt";
    ...
    std::vector<int> starting_vertexes = {0, 0b1111110000, 0b1110001110, 0b0001111110 };
