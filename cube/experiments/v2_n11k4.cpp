...
int main(int argc, char** argv) {
    // Пути можно задать аргументами:  v2_n11k4 <путь к kissat> <рабочий каталог>
    ...
    const std::string FILENAME  = workdir + "/n11k4.txt";
    ...
    std::vector<int> starting_vertexes = {0, 0b11110000000 };
