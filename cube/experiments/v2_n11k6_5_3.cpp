...
int main(int argc, char** argv) {
    // Пути можно задать аргументами:  v2_n11k6_5_3 <путь к kissat> <рабочий каталог>
    ...
    const std::string FILENAME  = workdir + "/n11k6_5_3.txt";
    ...
    std::vector<int> starting_vertexes = {0, 0b11111100000, 0b11100011100, 0b01010110110, 0b10010111001 };
